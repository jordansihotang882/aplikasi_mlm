...
<div class="row">
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Form Update Obat Masuk</h4>
                    <p class="card-description"> Basic form elements </p>
                      <?php foreach($data_obat as $plk) : ?>
                    <form class="forms-sample" method="post" action="<?php echo base_url('admin/obat_masuk/update_aksi') ?>">
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        <label for="exampleInputPassword4">Suplier</label>
                        <input type="text" name="nama_suplier" class="form-control" value="<?php echo $plk->nama_suplier ?>" readonly>
                      </div>
                      <div class="form-group">
